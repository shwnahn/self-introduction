...
fetch("https://m.search.naver.com/p/csearch/content/apirender.nhn?where=nexearch&pkid=387&u2=20010119&q=%EC%83%9D%EB%85%84%EC%9B%94%EC%9D%BC+%EC%9A%B4%EC%84%B8&u1=m&u3=solar&u4=5&_=1720073533454")
...
function initializeSections() {
    ...
    let intervalId = setInterval(showAfterSection, 2000);

    const resetInterval = () => {
        clearInterval(intervalId)
        intervalId = setInterval(()=> {showAfterSection()}, 2000);
    } 
